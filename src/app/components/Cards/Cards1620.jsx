...
import actividades from '../../../mocks/1620Meses.json'
...
export default function Cards1620 (){
    ...
    const dieciseisVeinteMeses = actividades.actividades.filter((actividad) => actividad.edad === "16 a 20 meses" && actividad.tipo === "principal");
    const dieciseisVeinteMesesExtra = actividades.actividades.filter((actividad) => actividad.edad === "16 a 20 meses" && actividad.tipo === "extra");
    return (
                ...
                <motion.div className='w-screen overflow-hidden flex flex-col items-center justify-center'>
                    {
                        ...
                        {dieciseisVeinteMeses.map((actividad) => (
                            <div key={actividad.id} className=" w-[300px] h-[180px] flex flex-col items-center justify-between bg-white bg-opacity-70 shadow-lg backdrop-filter backdrop-blur-md border border-opacity-18 p-5 rounded-md  sm-m:min-w-[300px] sm:w-[300px] cursor-grab">
                                ...
                                <Link href={'https://agesandstages.com/wp-content/uploads/2023/05/18-month_ASQ-3-Parent-Activities_Spanish.pdf'} target='_blank' className=" flex flex-col gap-2">
                    ...
                    
                    {
                        mostrarCards && (
                            ...
                            <motion.div className="  overflow-hidden flex justify-start items-center gap-5 mb-10 mt-10 sm:gap-5 h-[375px] cursor-grab px-10" drag='x' dragConstraints={{right: 3040, left: -3040}} initial={{ x: 3040 }}>
                                ...
                                {dieciseisVeinteMesesExtra.map((actividad) => (
