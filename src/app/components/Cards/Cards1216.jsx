...
import actividades from '../../../mocks/1216Meses.json'
...
export default function Cards1216 (){
    ...
    const doceDieciseisMeses = actividades.actividades.filter((actividad) => actividad.edad === "12 a 16 meses" && actividad.tipo === "principal");
    const doceDieciseisMesesExtra = actividades.actividades.filter((actividad) => actividad.edad === "12 a 16 meses" && actividad.tipo === "extra");
    return (
                    ...
                    
                    {
                        mostrarCards && (
                            ...
                            <motion.div className="  overflow-hidden flex justify-start items-center gap-5 mb-10 mt-10 sm:gap-5 h-[375px] cursor-grab px-10" drag='x' dragConstraints={{right: 3040, left: -3040}} initial={{ x: 3040 }}>
                                ...
                                {doceDieciseisMesesExtra.map((actividad) => (
